...
void cardIsCouncilRoom(int , int currentPlayer, struct gameState *state, int handPos);

void cardIsSmithy(int , int currentPlayer, struct gameState *state, int handPos);

void cardIsVillage(int currentPlayer, struct gameState *state, int handPos);

void cardIsFeast(int, struct gameState *state, int currentPlayer, int temphand[MAX_HAND], int x, int choice2);
